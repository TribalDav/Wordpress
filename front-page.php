    ...
    <div id="carouselFrontPage" class="carousel carousel-dark slide h-100" data-bs-ride="false">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active h-100">
                <a href="<?= get_site_url() ?>/boardgame/la-cathedrale-rouge/"><img src="<?php echo get_theme_root_uri() ?>/wordpress/assets/image/cathedrale.png" class="img-fluid w-100 d-block photocarrousel m-auto mt-3" alt="..."></a>
            ...
            <div class="carousel-item h-100">
                <a href="<?= get_site_url() ?>/boardgame/creature-comforts/"><img src="<?php echo get_theme_root_uri() ?>/wordpress/assets/image/creature.png" class="d-block w-100 photocarrousel m-auto mt-3" alt="..."></a>
            ...
            <div class="carousel-item h-100">
                <a href="<?= get_site_url() ?>/boardgame/zero-a-100/"> <img src="<?php echo get_theme_root_uri() ?>/wordpress/assets/image/zero.png" class="d-block w-100 photocarrousel m-auto mt-3" alt="..."></a>
...
if (have_posts()) :
    while (have_posts()) : the_post(); ?>
        <!-- DIV affichage des posts avec ACF -->
